  ...
  return (
    <div className="relative border mt-5 p-5 rounded-lg">
      <div className="flex items-center">
        <div className="">
          <img src={item.imageOne} alt="" width={"300px"} />
        </div>
        <div className="ml-8 w-full">
          <p className="text-gray-600 text-sm text-left md:text-xl font-semibold ">
            {item.name}
          </p>
          <div className="flex items-center mt-2">
            <strong className="flex items-center">
              <MdProductionQuantityLimits className="text-black-600" />
              <div className=" ml-2 w-20 flex border rounded-md p-1 justify-between items-center cursor-pointer ">
          ...
          <div className="mt-2 flex items-center">
            <TbTruckDelivery className="text-green-600" />
